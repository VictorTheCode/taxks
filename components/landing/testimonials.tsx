    ...
    <section className="py-32 bg-[#0d0e15] overflow-hidden border-y border-white/[0.03] relative">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="pointer-events-none absolute inset-y-0 left-0 w-48 bg-gradient-to-r from-[#0d0e15] to-transparent z-10" />
          <div className="pointer-events-none absolute inset-y-0 right-0 w-48 bg-gradient-to-l from-[#0d0e15] to-transparent z-10" />
        </div>
      </div>
    </section>
  );
