...
const TaskItem = ({ task, onToggle }: TaskItemProps) => {
  return (
    <div className="flex items-center gap-3 px-4 py-3 border-b border-white/4 hover:bg-white/2 transition-colors group">
      {/* Checkbox */}
      <button
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        ...
        <span className="text-[10px] font-mono text-white/20">{task.due}</span>
      </div>
    </div>
  );
};
